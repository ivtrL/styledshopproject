          ...
          <Popover key={category.name} className="flex">
            {({ open }) => (
              <>
                ...
                <Popover.Overlay className="fixed inset-0 bg-black opacity-50 transition ease-out duration-200" />
                <Transition
                  as={Fragment}
                  ...
                  leaveTo="opacity-0"
                >
                  <Popover.Panel className="absolute inset-x-0 top-full text-sm dark:text-gray-200 text-gray-900">
                    ...
                    <div className="relative dark:bg-gray-950 bg-white">
